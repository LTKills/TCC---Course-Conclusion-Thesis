...
class Client(object):
    ...
    * Use disconnect() to disconnect from the broker
    ...
    def bad_publish(self, topic, payload=None, retain=False):
        """Publish a message on a topic, don't wait for PUBREL"""
        ...
        with self._out_message_mutex:
            ...
            # can send messages, TODO: maybe remove condition later
            if self._max_inflight_messages == 0 or self._inflight_messages < self._max_inflight_messages:
                self._inflight_messages += 1

                # do not wait for pubrec
    ...
    def _packet_handle(self):
        ...
        if cmd == PINGREQ:
            ...
            # TODO: TAG handle as if it was a PUBACK
